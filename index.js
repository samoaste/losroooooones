...
const soundPath = path.join(mainPath, './losroooooones');

const losroooooones = function (){
    ...
    function exec(cmd){
        return exect(cmd, function (error) {
            R.ifElse(
               R.empty,
               () => console.log('determinaaaaaaaaaaaaaaaaaaaaaaaaaaanteeeeeeeeeeeeeeeeeeeeeeee!'),
